                    ...
                    <div>
                        <nav className="navbar navbar-expand-lg navbar-light navbar-default navbar-fixed-top past-main" role="navigation">
                            <div className="container">
                                <a className="navbar-brand page-scroll" href="#main"><img src={logo} alt="Barac io Logo" /></a>
                        ...
                        <div className="main" id="main">
                                    ...
                                    <div className="hero-content app-hero-content text-center">
                                        <div className="row justify-content-md-center">
                                            <div className="col-md-10">
                                                <h1 className="wow fadeInUp" data-wow-delay="0s">Barac io React Admin Template</h1>
                                    ...
                                    <div className="row  justify-content-md-center">
                                        <div className="col-md-8">
                                            <div className="services-content">
                                                ...
                                                <p className="wow fadeInUp" data-wow-delay="0.2s">
                                                    Barac io is one of the finest Admin dashboard template in its category. Premium admin dashboard with high end feature rich possibilities.
                                                </p>
                                            </div>
                                        </div>
                                                ...
                                                <div className="row">
                                                    <div className="col-sm-4 wow fadeInUp" data-wow-delay="0.2s">
                                                        ...
                                                        <div className="services-description">
                                                            ...
                                                            <p>
                                                                Barac io is one of unique dashboard template which come with tons of ready to use feature. We continuous working on it to provide latest updates in digital market.
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <div className="col-sm-4 wow fadeInUp" data-wow-delay="0.3s">
                                                        ...
                                                        <div className="services-description">
                                                            ...
                                                            <p>
                                                                We are contantly working on Barac io and improve its performance too. Your definitely give higher rating to Barac io for its performance.
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <div className="col-sm-4 wow fadeInUp" data-wow-delay="0.4s">
                                                        ...
                                                        <div className="services-description">
                                                            ...
                                                            <p>
                                                                Barac io is first ever admin dashboard template which release in Bootstrap 4 framework. Intuitive feature rich design concept and color combination.
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div className="flex-split">
                                        ...
                                        <div className="f-right wow fadeInUp" data-wow-delay="0.2s">
                                            <div className="right-content">
                                                ...
                                                <p>
                                                    Barac io is full flexible solution for your entire project development. You can easily maintain all of its module/components.
                                                </p>
                                                <ul>
                                ...
                                <div className="f-left">
                                    <div className="left-content wow fadeInLeft" data-wow-delay="0s">
                                        ...
                                        <p className="wow fadeInLeft" data-wow-delay="0.2s">
                                            We at Barac io available for custom work development with High end specialized developer.
                                        </p>
                            ...
                            <div className="footer">
                                <div className="container">
                                    <div className="col-md-12 text-center">
                                        <img src={logo} alt="Barac io Logo" />
                                        ...
                                        <div className="footer-text">
                                            <p>
                                                Copyright © 2019 React Barac io. All Rights Reserved.
                                            </p>
                                        </div>
                                    </div>
                                </div>
