                ...
                <Row>
                    ...
                    <Col md={6} xl={4}>
                        <Card className='lazy-dog'>
                            <Card.Header>
                                <Card.Title as='h5'>Do you know Barac io is released?</Card.Title>
                            </Card.Header>
                            <Card.Body>
                                <Card.Text>Barac io comes with Bootstrap 4 & Angular 7+ and React. It is best kind of own Dashboard categoty.</Card.Text>
                            </Card.Body>
                        </Card>
                    </Col>
                    <Col md={6} xl={4}>
                        <Card className='Design-sprint theme-bg2'>
                            <Card.Header className='borderless'>
                                <Card.Title as='h5' className='text-white'>Do you know Barac io is released?</Card.Title>
