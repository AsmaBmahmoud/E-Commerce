            ...
            <Aux>
                <Row>
                    <Col md={6} xl={4}>
                        <Card>
                            <Card.Body>
                                <h6 className='mb-4'>Unique Ip Adresses</h6>
                                <div className="row d-flex align-items-center">
                                    <div className="col-9">
                                        <h3 className="f-w-300 d-flex align-items-center m-b-0"><i className="feather icon-map-pin text-c-red f-30 m-r-5"/> 249.95</h3>
                                    </div>
                                </div>
                    ...
                    <Col md={6} xl={4}>
                        <Card>
                            <Card.Body>
                                <h6 className='mb-4'>Number of sessions</h6>
                                <div className="row d-flex align-items-center">
                                    <div className="col-9">
                                        <h3 className="f-w-300 d-flex align-items-center m-b-0"><i className="feather icon-map-pin text-c-dark f-30 m-r-5"/> 2.942.32</h3>
                                    </div>
                                </div>
                                <div className="progress m-t-30" style={{height: '7px'}}>
                    ...
                    <Col xl={4}>
                        <Card>
                            <Card.Body>
                                <h6 className='mb-4'>Amount of data (bytes)</h6>
                                <div className="row d-flex align-items-center">
                                    <div className="col-9">
                                        <h3 className="f-w-300 d-flex align-items-center m-b-0"><i className="feather icon-map-pin text-c-green f-30 m-r-5"/> 8.638.32</h3>
                                    </div>
                                </div>
                                <div className="progress m-t-30" style={{height: '7px'}}>
                    ...
                    <Col md={6} xl={8}>
                        <Card>
                            <Card.Header>
                                <Card.Title as='h5'>Attacks over time</Card.Title>
                            </Card.Header>
                            <Card.Body>
